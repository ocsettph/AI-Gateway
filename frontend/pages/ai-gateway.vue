...
useHead({
  title: "UBU AI SERVICE - AI Gateway",
})
    ...
    <div class="flex items-center gap-8 relative z-10">
      ...
      <div class="grid md:hidden grid-cols-2 gap-4 w-full mt-24 z-10 px-4">
        <NuxtLink
          ...
          :key="`card-m-${index}`"
          :to="card.href"
          class="w-full flex items-center justify-center dark:!bg-[#1a1a1a] dark:hover:!bg-[#222222] bg-white hover:bg-gray-50 rounded-lg shadow-sm border border-gray-200 dark:border-gray-800 p-4 block min-h-0"
          :style="{
            aspectRatio: '1/1',
          }"
        >
